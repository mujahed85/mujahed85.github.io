...
\includegraphics[width=0.87421in,height=0.92262in]{media/50_Oracle_Cloud_Infrastructure.png}
...
\begin{minipage}[t]{\textwidth}
  ...
  \hfill
  \raisebox{-0.3\height}{\includegraphics[width=1.25in,height=0.45in]{media/image22.png}}
\end{minipage}
...
\begin{itemize}
  ...
  \begin{minipage}[t]{\textwidth}
    ...
    \hfill
    \raisebox{-0.3\height}{\includegraphics[width=1.5cm]{media/image23.png}}
  \end{minipage}
    ...
    \begin{itemize}
      ...
      \item
        \begin{minipage}[t]{\textwidth}
          ...
          \hfill
          \raisebox{-0.3\height}{\includegraphics[width=1.2cm]{media/image25.png}}
        \end{minipage}
    \end{itemize}
