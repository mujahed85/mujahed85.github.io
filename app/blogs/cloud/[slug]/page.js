...
const cloudSlugs = blogsData.filter(post => post.tags && post.tags.some(tag => tag.toLowerCase().includes('cloud'))).map(post => post.slug);
...
export default async function BlogPostPage({ params }) {
  ...
  return (
    <div className="container my-5">
      <a href="/blogs/cloud" className="btn btn-link mb-3">&larr; Back to Cloud Blogs</a>
